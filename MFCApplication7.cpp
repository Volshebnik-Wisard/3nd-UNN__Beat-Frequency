// MFCApplication7.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMFCApplication7App

CMFCApplication7App theApp;


// Инициализация CMFCApplication7App
